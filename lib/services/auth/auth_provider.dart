// Create an abstract class 'similar to interface' that gets that user, and have the operations that will be done to that user. So you're hiding all the other operations that can be done on the user and only showing what u really want to be shown 'first step'.
